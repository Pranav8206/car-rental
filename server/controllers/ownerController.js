...
export const addCar = async (req, res) => {
    try {
        ...
        if (!req.file){
            res.json({success: false, message: "Upload car image"}) 
        }
        ...
        //optimization hrouth imagkit url transformation
...
export const toogleCarAvailability = async (req, res) => {
    try {
        ...
        res.json({success: true, message: "Availability of car Changed."})
    } catch (error) {
        console.log(error.message);
        res.json({success: false, message: error.message})
    }
